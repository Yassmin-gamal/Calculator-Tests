...
public class BaseTest {
    ...
    public void setUp() throws MalformedURLException {
        ...
        caps.setCapability(MobileCapabilityType.DEVICE_NAME, "SM A145F"); // Change to your device name
        caps.setCapability("udid", "RK8W5048BXB");
        caps.setCapability("plarformVersion", "13.0");
